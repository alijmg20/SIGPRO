...
<nav class="navbar navbar-dark bg-primary navbar-expand-sm sticky-top">
	<div class="container">
		<a class="navbar-brand" href="index.php">
			<img src="Vistas/logo/logo.png" width="182" height="57" class="d-inline-block align-top" alt="" loading="lazy">
		</a>
...
<section>
	<div class="container">
		...
		<div class="row" style="padding: 20px">
			...
			<div class="col-md-12 col-lg-5 d-flex justify-content-center">
				<img src="Vistas/img/porcentaje.png" class="img-fluid rounded border" alt="Equipo">
			</div>
			<div class="col-md-12 col-lg-1"></div>
			<!--Aux-->
		</div>
